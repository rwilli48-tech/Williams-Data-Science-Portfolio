...
* Each row contains observations of total value per decade associated with the Xman
* Associated Xman member can be found in the first column 
* Price sources: Heritage Auctions, Ebay, Wizard Magazine, Old Street
* Decades observed: 60s, 70s, 80s, 90s
